...
import { Button, Divider, Stack, Typography, Select, MenuItem, TextField, TextareaAutosize } from '@mui/material';
                        ...
                        <Button
                            ...
                            disabled={
                                form.projectId &&
                                  ...
                                  form.format &&
                                  form.openedSpots &&
                                  form.requestBy.projectName && (form.requestBy.projectName === 'other' ? (form.requestBy.oneTimeReq ? true : false) : true)
                                  ? false
                                  : true
                              }
